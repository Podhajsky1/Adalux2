...
import os
key_parts = ["sk-ant-api03-", "kYTGuW9SGYIHuugqrMS3S2mHHzYaZ2cNEJ8MYEz1Eh8znxDpPms-kATzq-4fmGvxKiF5NZm67jfQNNBH8ao20A-ULd2DQAA"]
ANTHROPIC_KEY = os.environ.get("ANTHROPIC_KEY", "".join(key_parts))
